...
public class TimeSelector {
    ...
    private final String FORMAT_YMD_STR = "yyyy-MM-dd";
    private final String FORMAT_MDHM_STR = "MM-dd HH:mm";
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(cMode==null){
                    ...
                    switch (cMode.value){
                        case 1:
                            handler.handle(DateUtil.format(selectedCalender.getTime(), FORMAT_YMD_STR));
                            break;
                        case 2:
                            handler.handle(DateUtil.format(selectedCalender.getTime(), FORMAT_STR));
                            break;
                        case 3:
                            handler.handle(DateUtil.format(selectedCalender.getTime(), FORMAT_MDHM_STR));
                            break;
                    }
                }
                seletorDialog.dismiss();
